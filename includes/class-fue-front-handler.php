...
class FUE_Front_Handler {
	...
	public static function process_subscription_request() {
		...
		$first_name = ! empty( $_POST['fue_first_name'] ) ? wc_clean( $_POST['fue_first_name'] ) : '';
		$last_name  = ! empty( $_POST['fue_last_name'] ) ? wc_clean( $_POST['fue_last_name'] ) : '';
	...
	public static function preview_email() {
		...
		$data = array(
			...
			'customheader'     => $email->customheader,//this is for customheader(aaa)
